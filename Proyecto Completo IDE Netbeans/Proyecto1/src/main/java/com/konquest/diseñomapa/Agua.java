...
public class Agua extends Planeta{
    ...
    public Agua(String nombrePlaneta, String tipoGuerrero, int dineroProducido, double probabilidadDistribucion, int cantidadGuerreros){
    ...
    public void printMe(){
        ...
        System.out.println("------------");
        System.out.println("GUERRERO: " + getTipoGuerrero() + "\nDINERO PRODUCIDO: " + "Entre 60-120 Galactus" 
        + "\nCANTIDAD GUERREROS: " + "Entre 12-23 Guerreros Nemo" + "\n");
    }
}
