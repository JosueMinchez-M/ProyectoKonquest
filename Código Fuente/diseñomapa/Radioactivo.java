...
public class Radioactivo extends Planeta{
    ...
    public Radioactivo(String nombrePlaneta, String tipoGuerrero, int dineroProducido, double probabilidadDistribucion, int cantidadGuerreros){
    ...
    public void printMe(){
        ...
        System.out.println("-------------------");
        System.out.println("GUERRERO: " + getTipoGuerrero() + "\nDINERO PRODUCIDO: " + "Entre 90-180 Galactus" 
        + "\nCANTIDAD GUERREROS: " + "Entre 3-9 Guerreros Mole" + "\n");
    }
}
